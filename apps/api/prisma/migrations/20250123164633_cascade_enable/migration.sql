/*
  ...
  - You are about to drop the column `projectId` on the `invites` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "invites" DROP CONSTRAINT "invites_projectId_fkey";
...
-- AlterTable
ALTER TABLE "invites" DROP COLUMN "projectId",
